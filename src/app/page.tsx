      ...
      <div className="fixed bottom-0 inset-x-0 z-40 lg:hidden bg-white/95 backdrop-blur-lg border-t border-stone-200 px-5 py-4 flex items-center justify-between gap-4 shadow-[0_-10px_20px_rgba(0,0,0,0.05)]">
        <div className="flex flex-col justify-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[8px] font-bold uppercase tracking-wider text-white bg-amber-600 px-1.5 py-0.5 rounded-sm">Save ₦1,000</span>
          </div>
            ...
            <div className="flex-1 text-center md:text-left w-full">
              ...
              <div className="flex items-center justify-center md:justify-start gap-4">
                ...
                <div className="flex flex-col items-start gap-1.5">
                  ...
                  <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-wider text-white bg-amber-600 px-2 py-0.5 rounded-sm">Save ₦1,000</span>
                </div>
              </div>
            </div>
